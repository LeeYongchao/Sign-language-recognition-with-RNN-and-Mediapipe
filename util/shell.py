...
def main(input_data_path,output_data_path,output_file_path):
        ...
        for file in listfile:
                ...
                if not(os.path.isdir(output_file_path+word)):
                        os.mkdir(output_file_path+word)
                os.system(comp)
                if file==".DS_Store":
                        continue
                for mp4list in fullfilename:
                        inputfilen='   --input_video_path='+input_data_path+word+mp4list
                        outputfilen='   --output_video_path='+output_data_path+word+mp4list
...
if __name__ == "__main__":
        ...
        main(input_data_path,output_data_path,output_file_path)
